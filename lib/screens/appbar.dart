...
class BNBCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.60, 0, size.width * 0.35, 0);
    path.quadraticBezierTo(size.width * 0.60, 0, size.width * 0.40, 20);
    path.arcToPoint(Offset(size.width * 0.60, 0), radius: Radius.circular(20.0), clockwise: false);
